...
\newcommand{\ThesisTitle}{CyclicL - Towards Automating Requirements Traceability in Product Line Engineering}
...
\newacronym{EOL}{EOL}{Epsilon Object Language}
...
\newacronym{ETL}{ETL}{Epsilon Transformation Language}

\newacronym{EML}{EML}{Epsilon Merging Language}
...
\newacronym{CIA}{CIA}{Change Impact Anlaysis}

\newacronym{FDD}{FDD}{Feature-Driven Development}

\newacronym{FODA}{FODA}{Feature-Oriented Domain Analysis}

\newacronym{FORM}{FORM}{Feature-Oriented Reuse Method}

\newacronym{UCD}{UCD}{Use Case Diagram}

\newacronym{ACC}{ACC}{Adaptive Cruise Control}

\newacronym{AQL}{AQL}{Acceleo Querying Language}

\newacronym{EVL}{EVL}{Eclipse Validation Language}
