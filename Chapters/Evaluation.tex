...
We currently have limited support for iterative changes according to our definition. The metamodel for \tool\, however, was defined to support iterative changes. Leveraging the \ac{AQL} and the \ac{EVL} that are present in the \ac{EMF}, we can query models created to perform \ac{CIA}.
