...
\begin{enumerate}
	...
	\item Identify system features based on use cases. These are the high-level features for our system. This is where the overlap between features and use cases can be leveraged to equate use cases from \gls{UML} to features in \gls{PLE}
