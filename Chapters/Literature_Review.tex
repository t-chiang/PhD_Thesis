...
\gls{PLE} has become a popular approach to handling diversity and complexity in a companies product portfolio since its original conception by Kang et al.~\cite{kang1990feature, kang2002feature}. We scoped the related work to some fundamentals of \gls{PLE} and some concrete implementations (tool support). As one of the objectives for this thesis is to add little extensions to the existing theories of product families we paid special attention to formal specifications and existing tools.
